<div class="tab-pane fade" id="edit-subs">
    ...
    @if($tts->count())
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-header header-elements-inline">
                                <h6 class="card-title font-weight-bold">{{ ($tt->exam_date ? 'Avaliação ('.date('D\, d/m/Y', strtotime($tt->exam_date)).')' : $tt->day) }} {{ '('.$tt->time_slot->full.')' .' - '.$tt->subject->name }}</h6>
                                <div class="header-elements">
                                    <div class="list-icons">
                                        <a onclick="confirmDelete(this.id)" href="#" id="{{ $tt->id }}" title="EXCLUIR"
                                    ...
                                    <form  method="post" action="{{ route('tt.update', $tt->id) }}">
                                        ...
                                        @if($ttr->exam_id)
                                            ...
                                            <div class="form-group row">
                                                <label class="col-lg-3 col-form-label font-weight-semibold">Data da
                                                    Avaliação <span class="text-danger">*</span></label>
                                                <div class="col-lg-9">
                                        ...
                                        @else
                                            ...
                                            <div class="form-group row">
                                                <label for="day"
                                                       class="col-lg-3 col-form-label font-weight-semibold">Dia
                                        ...
                                        <div class="form-group row">
                                            <label for="subject_id"
                                                   class="col-lg-3 col-form-label font-weight-semibold">Disciplina
                                                <span class="text-danger">*</span></label>
                                            <div class="col-lg-9">
        ...
        <div class="form-group row">
                ...
                <div class="col-lg-9">
                    <select data-placeholder="Selecionar Horário..." required class="select form-control" name="ts_id" id="ts_id">
                        ...
                        @endforeach
                                        ...
                                        <div class="text-right">
                                            <button type="submit" class="btn btn-primary">Enviar Formulário <i class="icon-paperplane ml-2"></i>
                                            </button>
                                        </div>
                                    </form>
                                </div>
        ...
        @endforeach
    @else
        <div class="alert alert-info text-center">Não há registros para exibir. Adicione disciplinas ao registro de horário
            e atualize a página
        </div>
    @endif
</div>
