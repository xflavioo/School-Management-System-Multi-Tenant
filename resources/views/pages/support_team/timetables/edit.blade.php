...
@section('page_title', 'Editar Registro de Horário')
@section('content')

    <div class="card">
        <div class="card-header header-elements-inline">
            <h6 class="card-title">Editar Registro de Horário</h6>
            {!! Qs::getPanelOptions() !!}
        </div>
            ...
            <div class="col-md-8">
                <form class="ajax-update" method="post" action="{{ route('ttr.update', $ttr->id) }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input name="name" value="{{ $ttr->name }}" required type="text" class="form-control" placeholder="Nome do Horário">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <select class="select form-control" name="exam_id" id="exam_id">
                                <option value="">Horário de Turma</option>
                                @foreach($exams as $ex)
