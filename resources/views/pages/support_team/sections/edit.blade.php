...
@section('page_title', 'Editar Seção de '.$s->my_class->name)
@section('content')

    <div class="card">
        <div class="card-header header-elements-inline">
            <h6 class="card-title">Editar Seção de {{ $s->my_class->name }}</h6>
            {!! Qs::getPanelOptions() !!}
        </div>
                ...
                <div class="col-md-6">
                    <form class="ajax-update" method="post" action="{{ route('sections.update', $s->id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input name="name" value="{{ $s->name }}" required type="text" class="form-control" placeholder="Nome da Seção">
                            </div>
                        </div>

                        <div class="form-group row">
                            <label for="my_class_id" class="col-lg-3 col-form-label font-weight-semibold">Turma </label>
                            <div class="col-lg-9">
